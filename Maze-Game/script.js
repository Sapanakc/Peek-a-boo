...
function Player(maze, c, _cellsize, onComplete, sprite = null) {
    ...
    function showJumpscare() {
        var ghostImage = document.getElementById("ghostImage");
        var screamSound = document.getElementById("screamSound");
        ghostImage.style.display = "block";
        screamSound.play();
        setTimeout(function () {
            ghostImage.style.display = "none";
        }, 6000);  // Display the ghost image for 6 seconds
    }

    function check(e) {
        console.log("Key code:", e.keyCode); // Debugging line
        ...
        switch (e.keyCode) {
            case 65:
            case 37: // west (left)
            console.log("Trying to move left"); // Debugging line
            console.log("cell.w:", cell.w); // Debugging line
            if (cell.w === true) {
                console.log("Moving left"); // Debugging line
...
sprite = new Image();
sprite.src = "./player.png?" + new Date().getTime();
...
player.bindKeyDown(); // Ensure this line is included
}